...
export async function GET(req: NextRequest) {
  ...
  if (!(await hasModuleEntitlement(tenantId, MODULE_KEYS.REVIEWER_MARKETPLACE))) {
    return NextResponse.json({ error: "Reviewer marketplace intelligence is not included in this tenant's plan" }, { status: 403 });
  }
